...
function obtenirProduits(dossier)
{
    ...
    }).done(function(produits)
    {
        ...
        for(var i = 0; i < produits_sans_prix_speciaux.length; i++)
        {
            ...
            //$("#datalist").append('<li>' + produits_sans_prix_speciaux[i].numero_produit + " [" + produits_sans_prix_speciaux[i].designation_produit + '] </li>');
        }
        ...
        {
            alert("tu as sélectionné un produit")
        })

        // $("#referenceProduit").autocomplete({
        //     source: liste_produits,
        //     delay: 300,
        // });

        // var sources = $("#referenceProduit").autocomplete('option', 'source');
        // console.log(sources);
