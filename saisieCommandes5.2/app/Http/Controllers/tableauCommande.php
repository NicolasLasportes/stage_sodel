...
class tableauCommande extends Controller
{
    ...
    public function ajouterCommande(Request $request)
    {
        ...
        '$adresse2_client', '$adresse3_client', '$code_postal_client', '$ville_client', '$pays_client', '$telephone_client', '$prefixe_facture', '$nom_livraison', '$prenom_livraison', 
    ...
    public function modifierCommande(Request $request)
    {
        ...
        SOTYPO = '$type_commande', SOCOMM = '$', CECREF = '$reference_commande'";

        odbc_Exec($conn, $sql);

        $reponse = [
            'reponse' => 'Commande modifié avec succès'
        ];
